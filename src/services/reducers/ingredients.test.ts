...
type TBaseIngredientType = Omit<TFullIngredient, 'counter' | 'u_id'>

const bun_ingredient: TBaseIngredientType = {
...
const main_ingredient_1: TBaseIngredientType = {
...
const main_ingredient_2: TBaseIngredientType = {
...
it('get ingredients should be success', () => {
    let action: TIngredientsActions = ingredientsSuccessRequestAC([ main_ingredient_1, main_ingredient_2 ])
...
it('main count should be increased', () => {
    let action: TIngredientsActions = increaseItemCountAC(main_ingredient_1._id)
...
it('main count should be decreased', () => {
    let action: TIngredientsActions = decreaseItemCountAC(main_ingredient_1._id)
